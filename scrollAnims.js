...
{
   gsap.fromTo( header, { opacity: 0, y: "+=100" }, { opacity: 1, y: 0, scrollTrigger: { trigger: header, start: 'top 90%' } } )
} )


p2_articles_texts.forEach( text =>
{
   gsap.fromTo( text, { opacity: 0, x: "+=100" }, { opacity: 1, x: 0, scrollTrigger: { trigger: text, start: 'top 90%' } } )
} )


p2_articles_arrows.forEach( arrow =>
{
   gsap.fromTo( arrow, { opacity: 0, x: "-=100" }, { opacity: 1, x: 0, scrollTrigger: { trigger: arrow, start: 'top 90%' } } )
} )
...
gsap.fromTo( smallPic, { opacity: 0, x: "-=150", y: "-20%" }, { opacity: 1, x: 0, y: "-20%", scrollTrigger: { trigger: smallPic, start: 'top bottom' } } )